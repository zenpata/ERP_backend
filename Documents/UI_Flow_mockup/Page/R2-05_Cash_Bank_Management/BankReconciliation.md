...
| **Preview** | [`BankReconciliation.preview.html`](./BankReconciliation.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

เลือกรายการเคลื่อนไหวที่ตรงกับธนาคาร statement และทำการกระทบยอด
