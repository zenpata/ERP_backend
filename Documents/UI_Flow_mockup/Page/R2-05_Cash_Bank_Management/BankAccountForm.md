...
| **Preview** | [`BankAccountForm.preview.html`](./BankAccountForm.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

เพิ่มบัญชีใหม่พร้อม opening balance และ optional GL link (`glAccountId` ตาม schema BR)
