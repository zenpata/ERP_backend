...
| **Preview** | [`GoodsReceiptList.preview.html`](./GoodsReceiptList.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

แสดงรายการใบรับสินค้า (GR) ทั้งหมดในระบบ (read-only audit view) — การสร้าง GR ต้องเริ่มจาก PO detail ที่ approved แล้วเท่านั้น
