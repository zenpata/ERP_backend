...
| **Preview** | [`PurchaseOrderForm.preview.html`](./PurchaseOrderForm.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

สร้างหรือแก้ไขใบสั่งซื้อ (draft) — กรอก vendor, รายการสินค้า, วันที่, แผนก, งบโครงการ
...
## Sub-flow B — สร้าง PO (Create) / Sub-flow C — รายละเอียดและแก้ไข

**กลุ่ม endpoint:** `POST /api/finance/purchase-orders`, `PATCH /api/finance/purchase-orders/:id`
