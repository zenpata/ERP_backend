...
| **Preview** | [`OvertimeList.preview.html`](./OvertimeList.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

แสดงรายการคำขอล่วงเวลา (OT) พร้อม KPI สรุป (รอดำเนินการ/อนุมัติ/ปฏิเสธ/ชั่วโมงรวม) และตาราง OT ที่กรองตามสถานะ พนักงาน แผนก ประเภท OT และช่วงวันที่ได้
