...
| **Preview** | [`HolidayList.preview.html`](./HolidayList.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

แสดงปฏิทินวันหยุดประจำปี (นักขัตฤกษ์ + วันหยุดบริษัท) กรองตามปีและประเภท เพิ่ม/ลบวันหยุดได้ ใช้ใน attendance calculation และ payroll
