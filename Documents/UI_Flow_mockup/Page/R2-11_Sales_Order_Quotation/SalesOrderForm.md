...
**Route:** `/finance/sales-orders/:id` (detail / status) · สร้าง SO ใหม่ผ่านปุ่มใน List หรือ convert-to-so จาก QT
...
| **Preview** | [`SalesOrderForm.preview.html`](./SalesOrderForm.preview.html) · [`../_Shared/preview-base.css`](../_Shared/preview-base.css) · [`MD_TO_PREVIEW_HTML_MANUAL.md`](../MD_TO_PREVIEW_HTML_MANUAL.md) |

---

## เป้าหมายหน้าจอ

สร้าง / ดูรายละเอียด / เปลี่ยนสถานะ SO และดำเนินการ workflow (confirm, cancel, แปลง Invoice) พร้อมดู linked invoices
